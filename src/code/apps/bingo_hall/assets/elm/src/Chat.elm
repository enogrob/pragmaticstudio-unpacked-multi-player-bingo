...
{-| Renders the chat message form.

  - `onSubmitMsg` is the message produced when the form is submitted
  - `onInputMsg` is the message produced when text is input
...
that new messages are always displayed.
-}
